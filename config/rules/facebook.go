...
// This types.Rule includes both App Secret and Client Access Token
// https://developers.facebook.com/docs/facebook-login/guides/access-tokens/
func FacebookSecret() *types.Rule {
	// define types.Rule
	r := types.Rule{
	...
	// validate
	tps := []string{
		generateSampleSecret("facebook", utils.NewSecret(hex("32"))),
...
func FacebookAccessToken() *types.Rule {
	// define types.Rule
	r := types.Rule{
...
func FacebookPageAccessToken() *types.Rule {
	// define types.Rule
	r := types.Rule{
